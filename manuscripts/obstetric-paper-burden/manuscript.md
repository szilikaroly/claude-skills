# The price of single-use data: paper consumption in obstetric and antenatal documentation

### A micro-costing study of 100 care episodes with national extrapolation

**Authors** ⟦Author list, affiliations, ORCIDs, corresponding author⟧

**Target journal** ⟦To be selected. Candidates, in order: *BMC Health Services Research*; *BMC Pregnancy and Childbirth*; *Health Information Management Journal*; *Journal of Medical Systems*⟧

**Word count** Abstract 415; main text 4,684 — above the usual 3,000–4,000 for an original article; §3.7 (environmental) and parts of §4.3 are the natural cuts if the target journal imposes a limit. Tables 4, Figures 4, References 11 (retention decree and HTA guideline still to be added).

---

## Abstract

**Background.** Obstetric care is documented on paper in much of Europe, but the volume of that paper has almost never been counted. Cost arguments for digitising maternity records are therefore made from assertion rather than measurement, and the largest consequences — staff handling time and decades of statutory archival storage inside hospital buildings — are left out of the calculation entirely.

**Methods.** Retrospective bottom-up micro-costing study of documentation output in ⟦setting⟧. For 100 antenatal and delivery care episodes we counted printed pages in ten document categories. The primary outcome was printed pages per care episode. Counts were converted to sheets, mass, shelf length and archive floor area using stated physical constants, and costed using the centralised public procurement price of A4 80 g/m² paper and the tax authority's property valuation for the archive site. Four scenarios — current practice, duplex printing, electronic delivery of diagnostic reports, and a paperless pathway — were modelled at departmental (2,000 episodes/year) and national (77,500 births/year) scale, with one-way sensitivity analysis on all physical and valuation parameters.

**Results.** A care episode generated a mean of 131.3 printed pages (SD 10.5; 95% CI 129.2–133.4; median 130, IQR 124–138), occupying 124.3 sheets. Diagnostic reports accounted for 61.7% of pages, referrals for 13.4% and clinical records for 24.9%. Each referral generated exactly four report pages, so one referral costs five printed pages. Consumables cost 1,150 HUF net per care episode — 2.30 million HUF/year at departmental scale and 89.1 million HUF/year nationally (113.2 million gross), consuming 48.1 tonnes of paper. Toner and device cost, charged per printed page, accounted for 70.8% of that and is unaffected by duplex printing. Printing and filing the 45.6 documents each episode generates took an estimated 22.8 minutes, or 17.1 FTE nationally, and the archive occupied 5,751 m² of hospital floor — equivalent to 320 antenatal consulting rooms. At steady state under statutory retention the national archive holds 316 million sheets on 31,633 linear metres of shelving, occupying 5,751 m² and immobilising 8.97 billion HUF of property value — 115,772 HUF per care episode, and 101 times the annual consumable spend. Duplex printing, requiring no investment, removes 45.5% of sheets and 4.09 billion HUF of that value but only 14.2% of consumable cost. Electronic report delivery removes 78.2% of sheets, 6.77 billion HUF and 73.7% of consumable cost.

**Conclusions.** Paper consumption in obstetric care is dominated not by clinical narrative but by printed copies of results that already exist in electronic form, and its dominant cost is the property that paper occupies for thirty to fifty years. Duplex printing is free and halves the archive, but only electronic report delivery reduces both the recurrent and the capital burden. Because archivist labour and clinician handling time are excluded, these estimates are a floor.

**Keywords** health documentation; micro-costing; medical records; obstetrics; antenatal care; paperless; archives; health information exchange
...
- **Paper.** A4 80 g/m² copier paper under the framework agreements of the centralised public procurement system (KEF), at 1,430–1,460 HUF net per 500-sheet ream — 1,815–1,855 HUF gross — giving a base case of 1,445 HUF net per ream, or 2.89 HUF per sheet [10].
- **Printing.** 7 HUF per printed page (toner, device amortisation and service), the prevailing Hungarian cost-per-page charge, so a double-sided sheet costs 14 HUF. Because the charge is levied per page rather than per sheet, **duplex printing reduces paper but not toner** — an asymmetry that turns out to matter. Sensitivity range 5–10 HUF. We treat this as exclusive of paper, which is priced separately above; a single flag in the parameter file switches the model to an all-in interpretation if that is the local convention.
- **Archive floor area.** 1,560,000 HUF/m², the tax authority (NAV) property valuation applicable to the archive site [11]. This is a capital value — the property the archive immobilises — not an annual rent, and is reported as such.

The antenatal booklet is purchased as a finished item rather than printed, so it carries neither charge; its purchase price is not yet available to us and is excluded, which understates cost in every scenario and most in the paperless one.

Three cost components are **not** monetised because we do not yet hold defensible institutional unit costs for them: archivist labour for filing, retrieval and retention appraisal; clinician and administrator time spent handling paper; and the purchase price of the antenatal booklet. Their omission is one-directional — every one of them would increase the estimated cost of current practice — and the model is built so that they can be added without re-deriving anything else.
...
Consumables cost **1,150 HUF net per care episode** — a scale-invariant figure that transfers directly to any unit that knows its delivery volume. Its composition is itself informative: **70.8% is toner and device cost, only 29.2% is paper.** An institution that counts only its paper invoice sees under a third of what documentation actually costs it to produce.

At **departmental scale** (2,000 episodes/year) current practice prints 232,540 pages onto 248,540 sheets, consuming 1.24 tonnes of paper and costing **2.30 million HUF net** (2.92 million gross) per year — 1.63 million in printing and 672,000 in paper — or 19.6 million HUF discounted over ten years, and adds 25 linear metres to the archive annually.

At **national scale** (77,500 births, KSH 2024) it prints 9.01 million pages onto **9.63 million sheets, consumes 48.1 tonnes of paper and costs 89.1 million HUF net** (113.2 million gross) per year — 63.1 million in printing and 26.0 million in paper, with a range of 70.8–116.4 million across the unit-price ranges — or 760.9 million HUF discounted over ten years, and adds 963 linear metres of shelving annually. Tables 2 and 4 give all scenarios at both scales.

### 3.4 The archive: where the cost actually is

Annual paper spend is not the interesting number. Under statutory retention the steady-state national holding for these documents is **316 million sheets on 31,633 linear metres of shelving, occupying 5,751 m² of floor** and immobilising **8.97 billion HUF** of property value at the NAV valuation. The consumables cost 89.1 million HUF a year; the building the output lives in represents **101 times** that in tied-up capital. Per care episode this is **115,772 HUF of immobilised property against 1,150 HUF of consumables** — again scale-invariant, and at departmental scale it amounts to 231.5 million HUF held in 148 m² of archive.
...
**Duplex printing (S1)** requires no capital investment, no software and no legal change. It reduces output from 124.3 to 67.8 sheets per episode — a 45.5% reduction, short of 50% because odd page counts round up and the booklet is already double-sided — and cuts the steady-state archive to 3,130 m² and 4.88 billion HUF, **releasing 4.09 billion HUF of property value** (105.5 million HUF at departmental scale). But it leaves the number of *printed pages* untouched, so it saves nothing on toner: consumable spend falls only from 89.1 to 76.5 million HUF nationally, a **14.2% reduction** (327,000 HUF departmentally). It leaves handling time untouched for the same reason. Duplex is an archive intervention, not a printing-cost or a workforce intervention, and should be argued as one. A caveat is operational rather than economic: any form carrying a signature field on its reverse cannot be duplexed without redesign.

**Electronic result delivery (S2)** — retrieving diagnostic reports from the national exchange instead of printing them — is the only intervention that reduces both burdens at once. Printed pages fall from 116.3 to 35.3 per episode and sheets to 27.1, a 78.2% reduction. Consumable spend falls to 23.4 million HUF nationally, a **73.7% reduction** (1.70 million HUF saved departmentally), and the archive to 1,410 m² and 2.20 billion HUF, **releasing 6.77 billion HUF**. Handling time falls from 22.8 to 8.8 minutes per episode, releasing 466 hours a year departmentally and 10.5 FTE nationally. Measured on recurrent cost it is worth five times what duplex is worth; measured on capital, 1.7 times; measured on staff time, duplex is worth nothing at all.

**A paperless pathway (S3)**, retaining only the patient-held booklet, reduces printed output to zero and the archive to 338 m² and 0.53 billion HUF. Its apparent consumable cost of zero is an artefact of the missing booklet purchase price and should not be read as free. The residual is the booklet, and it is deliberate: a patient-held record that works offline has a function no electronic system replaces.
...
Four numbers carry the argument, and all are scale-invariant, so they transfer to any unit or country that knows its delivery volume and its property prices. The first is the composition: 62% reports against 14% generated clinical record. The second is the ratio between flow and stock: **1,150 HUF of consumables per care episode against 115,772 HUF of immobilised property** — a factor of 101. The third is inside the consumable figure itself: **70.8% of it is toner, not paper.** The fourth is that none of these capture the two largest burdens, because neither reaches an invoice: **22.8 minutes of staff handling per episode — 17.1 FTE nationally — and 5,751 m² of hospital floor withdrawn from clinical use.** Any analysis that stops at the annual stationery invoice, as cost arguments in this area usually do, sees under a third of the recurrent consumable cost, about one percent of the capital position, and none of the workforce or the space.
...
The limitations are substantial and we state them in order of severity.

*Derived report counts.* Report pages were not counted independently but derived from referrals at the institution's fixed 4:1 convention. If real reports vary in length, our estimate of the 69% report share is correspondingly soft, and the standard deviation of the total is understated. This is the first thing an external validation should measure.
...
*Costs omitted rather than estimated.* Archivist labour, clinician handling time and the purchase price of the antenatal booklet are excluded. All three are positive costs of current practice, so the direction of the resulting bias is known: **89.1 million HUF of annual consumables and 8.97 billion HUF of immobilised property nationally — 2.30 million and 231.5 million at departmental scale — are floors rather than central estimates.** The omitted booklet price also makes the paperless scenario look costless, which it is not.
...
*Printing charge interpretation.* We treat the 7 HUF per-page charge as toner and device cost exclusive of paper, and add paper on top. If the local convention is an all-in cost per page, consumable cost falls by the paper component; the parameter file carries a single flag for this and the model recomputes without further change.

*Property value is capital, not cash.* Immobilised property value is not an annual budget line, and releasing it requires the space to be repurposable. Where it is not, the saving is notional. We report it as capital deliberately and do not annuitise it. It is also valued at a single site's NAV assessment, which will not hold across a national archive estate.

*Archival conventions assumed.* Shelving density and floor efficiency are the two largest sources of uncertainty in the headline figure and are the cheapest to eliminate: both can be measured in an afternoon in a real archive.
...
Three studies would materially strengthen this line of work: a time-and-motion measurement of document handling, replacing the assumed 30 seconds with an observed distribution; a direct measurement of report length and of archival shelving density, replacing our two weakest assumptions; and a retrospective legibility audit of archived obstetric records at 10, 20, 30 and 40 years, which would test whether the long retention period actually delivers the legal protection it is designed to provide — the thermal-paper cardiotocograph trace being the obvious case where it may not.

---

## 5. Conclusion

An obstetric care episode generates about 131 printed pages, and about six in ten of them are printed copies of results that already exist electronically. The cost of that practice is not mainly the 1,150 HUF of consumables per episode — 89.1 million HUF a year nationally, 2.30 million HUF for a 2,000-delivery department, and 71% of it toner rather than paper — but the 115,772 HUF of property per episode immobilised by holding the output for three to five decades, 8.97 billion HUF nationally. Both figures exclude archivist labour, so both are floors. Nor is money the largest item: printing and filing those documents takes an estimated 22.8 minutes per episode, 17.1 full-time equivalents nationally, and the archive occupies 5,751 m² of hospital floor — 320 consulting rooms' worth — withdrawn from clinical use. Double-sided printing releases 46% of the capital immediately and for nothing, though it saves only 14% of the recurrent cost and no staff time at all, because toner and handling are charged by the page and by the document. Delivering diagnostic reports electronically releases 75% of the capital, 74% of the recurrent cost and 10.5 FTE. Neither requires a new hospital information system; both require deciding that a printed copy of an electronic result is not a record worth keeping for fifty years.
